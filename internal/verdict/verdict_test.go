...
// supportAppPredicate transcribes support-app's real predicate (docs/command-centre-v1.md § 8,
...
// servicesPredicate transcribes services' real predicate (docs/command-centre-v1.md § 8): six
